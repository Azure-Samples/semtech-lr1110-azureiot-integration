...
14. Once the deployment was successfull the Cloud Job View of the Azure Stream Analytics Tools extension should open and you should be able to start the job (and it does take some time until it is up and running and you can see it on your screen)
